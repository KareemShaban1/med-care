        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#categoriesModal" onclick="resetForm()">
...
<script>
    ...
    $('#categoriesForm').on('submit', function(e) {
        ...
        $('#statusHidden').val($('#status').is(':checked') ? 1 : 0);
    ...
    function editCategory(id) {
        $.get('{{ route("admin.categories.index") }}/' + id, function(data) {
            ...
            $('#categoriesForm').attr('action', '{{ route("admin.categories.update", ":id") }}'.replace(':id', id));
